...
ko['watch'] = function (target, options, evaluatorCallback, context) {
    ...
    switch (typeof ko.subscription == 'function' || ko.version) {
        ...
        case "3.5.0-pre": subscriptionsField = 'S'; break;
        default: throw "Unsupported Knockout version. Only v3.0.0 to v3.5.0-pre are supported when minified. Current version is " + ko.version;
    }
